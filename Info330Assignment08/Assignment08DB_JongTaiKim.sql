...
Begin -- Patients
	...
	Alter Table Patients
	 Add Constraint ckPatientsPhoneFormat
	  Check (PatientPhoneNumber Like '[0-9][0-9][0-9]-[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]' or 
			 PatientPhoneNumber Like '[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]')
...
Begin -- Doctors
	...
	Alter Table Doctors
	 Add Constraint ckDoctorsPhoneFormat
	  Check (DoctorPhoneNumber Like '[0-9][0-9][0-9]-[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]' or 
			 DoctorPhoneNumber Like '[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]')
...
Begin -- Clinics
	...
	Alter Table Clinics
	 Add Constraint ckClinicsPhoneFormat
	  Check (ClinicPhoneNumber Like '[0-9][0-9][0-9]-[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]' or 
			 ClinicPhoneNumber Like '[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]')
...
/*
	Alter Table Appointments
	 Add Constraint dfAppointmentsDate
	  Default Cast(getDate() as date) For AppointmentDate

	Alter Table Appointments
	 Add Constraint dfAppointmentsTime
	  Default Cast(getDate() as time) For AppointmentTime

	Alter Table Appointments
	 Add Constraint ckAppointmentAfterCurrent
	  Check (Cast(AppointmentDate as datetime) + Cast(AppointmentTime as datetime) >= getDate()) 	

	Alter Table Appointments
	 Add Constraint ckAppointmentBetweenWorkingHours
	  Check (AppointmentTime Between Cast('8:00:00' as time) and Cast('17:00:00' as time))
*/
End
Go
